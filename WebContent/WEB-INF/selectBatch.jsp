...
<div align="center">
    <h1>
        <center>Assign Trainer :</center>
    </h1>
    <br/>
    <form method="post" action="courseassignment">
        <table border="1" align="center">
            <tr>
                <th>Course Name | Start_Date | End_Date | Sessions</th>
                <th>Trainers</th>
            </tr>
                ...
                <td>
                    <select name="course">
                        ...
                        <%--<c:forEach var="course" items="${model.course_list}">--%>
                            <%--<option value='${course.name},${course.start_date},${course.end_date},${course.sessions}'>${course.name}--%>
                                <%--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;--%>
                                <%--|${course.start_date} &nbsp;&nbsp;&nbsp; | ${course.end_date}--%>
                                <%--| ${course.sessions}</option>--%>
                        <%--</c:forEach>--%>

                        <option value="batch">--- Select Batch ---</option>
                        <c:forEach var="course" items="${model.course_list}">
                            <option value='${course.name},${course.start_date},${course.end_date},${course.sessions}'>
                                ${course.name}
                                |${course.start_date}
                                |${course.end_date}
                                |${course.sessions}
